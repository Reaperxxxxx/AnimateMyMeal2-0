                            ...
                            <div class="kode-shop-detail">
                                ...
                                <div class="kode-text">
                                    ...
                                    <div class="product-info">
                                        <p><strong>Product ID:</strong> {{$asset->id}}</p>
                                        <p><strong>Category:</strong> {{App\CategoryAsset::where('id',$asset->id_Category)->pluck('name')->first()}}</p>
                                    </div>
                                    <!--PRODUCT INFO END-->
